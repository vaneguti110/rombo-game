...
/*In jquery, when working with color we need to specify with rgb */
var player1Color = 'rgb(90, 252, 3)';
...
// Start with Player One
$('h3').text(player1+": it is your turn, please pick a column to drop your green rombo shape.");
...
$('.board button').on('click',function() {
  ...
  if (currentPlayer === 1) {
    currentName = player1;
    $('h3').text(currentName+": it is your turn, please pick a column to drop your green rombo shape.");
    currentColor = player1Color;
  }else {
    currentName = player2
    $('h3').text(currentName+": it is your turn, please pick a column to drop your red rombo shape.");
